...
interface TributeItemProps {
  tribute: Tribute;
  memorialId: string;
  onLike: (memorialId: string, tributeId: string) => void;
}

const TributeItem: React.FC<TributeItemProps> = ({ tribute, memorialId, onLike }) => {
      ...
      <div className="flex-grow">
        ...
        <div className="flex justify-between items-center mt-4">
            ...
            <div className="flex items-center space-x-2">
                <button 
                    onClick={() => onLike(memorialId, tribute.id)} 
