            ...
            <div className="bg-pale-sky/50 rounded-lg p-8 border border-silver min-h-[400px]">
                {activeTab === 'story' && (
                    <section className="animate-fade-in">
                        ...
                        {/* 3. Secondary AI Snippet (Pull Quote) */}
                        {memorial.aiHighlights && memorial.aiHighlights.length > 1 && (
                            <div className="my-10 p-8 bg-paper-light border-y-2 border-deep-navy/10 text-center">
                                <span className="material-symbols-outlined text-4xl text-deep-navy/20 mb-4">format_quote</span>
                                <p className="text-xl md:text-2xl font-serif italic text-deep-navy/80 leading-relaxed max-w-3xl mx-auto">
                        ...
                        {memorial.donationInfo?.isEnabled && (
                            <section className="mt-12 pt-8 border-t border-silver animate-fade-in">
