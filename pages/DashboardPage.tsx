...
const DashboardPage: React.FC = () => {
  ...
  const { memorials, updateMemorialSlug, getFollowedMemorials } = useMemorials();
  const [editingUrlMemorial, setEditingUrlMemorial] = useState<Memorial | null>(null);

  const { myDrafts, myPublishedMemorials, publicMemorials, followedMemorials } = useMemo(() => {
    if (!currentUser) return { myDrafts: [], myPublishedMemorials: [], publicMemorials: [], followedMemorials: [] };
    ...
    return { myDrafts: drafts, myPublishedMemorials: published, publicMemorials: publicMems, followedMemorials: followed };
