            ...
            <div className="w-full bg-cover bg-center h-96 sm:h-[500px] relative" style={{ backgroundImage: `url('${heroImage}')` }}>
                ...
                <div className="relative h-full flex items-center justify-center text-center text-white">
                    <div className="max-w-4xl px-4">
                        <h1 className="text-4xl sm:text-6xl font-serif font-bold tracking-tight">Honor a Life.<span className="hidden sm:inline"> </span><br className="sm:hidden" />Share a Legacy.</h1>
